...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn(
        "border-b-border flex flex-col gap-2 border-b-2 p-2",
        className,
      )}
      {...props}
    />
...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn(
        "border-t-border flex flex-col gap-2 border-t-2 p-2",
        className,
      )}
      {...props}
    />
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        "border-b-border relative flex w-full min-w-0 flex-col border-b-2 p-2 last:border-b-0",
        className,
      )}
      {...props}
    />
